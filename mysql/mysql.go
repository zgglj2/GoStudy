...
// 删除数据
func deleteRowDemo(age int) {
	sqlStr := "delete from user where age = ?"
	ret, err := db.Exec(sqlStr, age)
	if err != nil {
...
func transactionDemo() {
	...
	sqlStr1 := "Update user set age=31 where id=?"
	...
	sqlStr2 := "Update user set age=41 where id=?"
...
func main() {
	...
	queryRowDemo()
	fmt.Println("queryRowDemo() finish")
	queryMultiRowDemo()
	fmt.Println("queryMultiRowDemo() finish")
	insertRowDemo()
	fmt.Println("insertRowDemo() finish")
	updateRowDemo()
	fmt.Println("updateRowDemo() finish")
	deleteRowDemo(18)
	deleteRowDemo(4)
	fmt.Println("deleteRowDemo() finish")
	prepareQueryDemo()
	fmt.Println("prepareQueryDemo() finish")
	prepareInsertDemo()
	fmt.Println("prepareInsertDemo() finish")
	transactionDemo()
	fmt.Println("transactionDemo() finish")
